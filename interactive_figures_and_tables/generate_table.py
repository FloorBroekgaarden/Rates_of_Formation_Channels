...
<div class="page-header">
  <div class="header-links">
    <a class="hdr-badge github" href="https://github.com/FloorBroekgaarden/Rates_of_Formation_Channels" target="_blank">
    ...
    <a class="hdr-badge zenodo" href="https://doi.org/10.5281/zenodo.7815200" target="_blank">
      <svg height="14" viewBox="0 0 24 24" width="14" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9V8h2v8zm4 0h-2V8h2v8z"/></svg>
      Zenodo&nbsp;DOI:&nbsp;10.5281/zenodo.7815200
    </a>
  </div>
