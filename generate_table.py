...
.legend{{display:flex;gap:14px;flex-wrap:wrap;padding:10px 14px;background:#fff;border-radius:8px;border:1px solid #e0e4ef;max-width:1500px;margin:12px auto 0}}
